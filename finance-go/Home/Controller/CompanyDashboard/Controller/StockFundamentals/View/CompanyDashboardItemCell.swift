//
//  CompanyDashboardItemCell.swift
...
class CompanyDashboardItemCell: UICollectionViewCell {
    var companyDashboardItem: CompanyDashboardItem? {
        didSet {
            guard let companyDashboardItem = companyDashboardItem else { return }
            iconView.image = companyDashboardItem.icon?.withRenderingMode(.alwaysTemplate)
            titleLabel.text = companyDashboardItem.title
...
extension CompanyDashboardItemCell {
