//
//  DividendCalendarViewController.swift
...
class DividendCalendarViewController: FGUIViewController {
    var monthViewDataSource = [DividendCalendar]()
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(didSelectDividendCalendarDate), name: .didSelectDividendCalendarDate, object: nil)
...
extension DividendCalendarViewController {
    @objc func didSelectDividendCalendarDate(notification: Notification) {
        guard let date = notification.object as? Date else { return }
        selectedDate = date
        dividendCalendars = DividendCalendarStore.shared.items(atDate: selectedDate)
        ...
        NetworkManager.shared.request(
            ...
            case let .success(data):
                DispatchQueue.background {
                    ...
                    self.monthViewDataSource = DividendCalendarStore.shared.items
                    self.dividendCalendars = DividendCalendarStore.shared.items(atDate: self.selectedDate)
                } completion: {
...
extension DividendCalendarViewController: UITableViewDelegate, UITableViewDataSource {
...
extension DividendCalendarViewController: JXSegmentedListContainerViewListDelegate {
